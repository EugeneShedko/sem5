...
int main()
{
	...
	try
	{
		...
		int optival = 1;
		if (setsockopt(sS, SOL_SOCKET, SO_BROADCAST, (char*)&optival, sizeof(int)) == SOCKET_ERROR)
		{
		...
		int lc = sizeof(clnt);
		char ibuf[50];
		/*if ((lb = sendto(sS, name.c_str(), sizeof(name), NULL, (sockaddr*)&all, sizeof(all))) == SOCKET_ERROR)
		{
